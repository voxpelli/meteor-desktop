...
export default class MeteorApp {
    ...
    async ensureDesktopHCPPackages() {
        const desktopHCPPackages = ['skadmin:meteor-desktop-watcher', 'communitypackages:meteor-desktop-bundler'];
    ...
    async acquireIndex() {
        ...
        const url = (this.$.env.options.skipMobileBuild && this.$.env.options.ddpUrl)
